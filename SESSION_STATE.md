...
16. Next：wire real wallet adapters behind Profile Hub session detection; contract-level minimum-output enforcement once swap contracts/router exist; continue liquid-glass page conformance on remaining routes.
