        ...
        <>
          <GlassPanel variant="mixed" noAurora padding="sm">
            ...
            <div className="mt-2 flex gap-2 text-[10px]">
              <span className="rounded bg-emerald-400/10 px-2 py-0.5 text-emerald-200">🟢 {data.marketSentiment.bullCount}</span>
              <span className="rounded bg-rose-400/10 px-2 py-0.5 text-rose-200">🔴 {data.marketSentiment.bearCount}</span>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-1 flex items-center gap-3 text-[10px] text-cyan-200/40">
                      <span>❤️ {sig.likes.toLocaleString()}</span>
                      <span>🔄 {sig.retweets.toLocaleString()}</span>
                      <span>💬 {sig.replies.toLocaleString()}</span>
      ...
      {loading ? (
        ...
        <>
          <GlassPanel variant="mixed" noAurora padding="sm">
            ...
            <div className="mt-2 flex gap-2 text-[10px]">
              <span className="rounded bg-emerald-400/10 px-2 py-0.5 text-emerald-200">🟢 {data.marketSentiment.bullCount} bullish</span>
              <span className="rounded bg-rose-400/10 px-2 py-0.5 text-rose-200">🔴 {data.marketSentiment.bearCount} bearish</span>
          ...
          <SegmentedControl label="Feed" onChange={(v) => setFeedTab(v as typeof feedTab)}
            options={[{ label: "🟢 Bullish", value: "bullish" },{ label: "🔴 Bearish", value: "bearish" },{ label: "⚪ Neutral", value: "neutral" },{ label: "📊 Trending", value: "trending" }]}
