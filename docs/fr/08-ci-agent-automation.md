**Languages:** [English](../08-ci-agent-automation.md) | [简体中文](../zh-CN/08-ci-agent-automation.md) | [繁體中文](../zh-TW/08-ci-agent-automation.md) | [Русский](../ru/08-ci-agent-automation.md) | [Español](../es/08-ci-agent-automation.md) | [Português](../pt/08-ci-agent-automation.md) | [العربية](../ar/08-ci-agent-automation.md) | [Français](./08-ci-agent-automation.md) | [Deutsch](../de/08-ci-agent-automation.md) | [日本語](../ja/08-ci-agent-automation.md) | [한국어](../ko/08-ci-agent-automation.md) | [हिन्दी](../hi/08-ci-agent-automation.md) | [Türkçe](../tr/08-ci-agent-automation.md) | [Italiano](../it/08-ci-agent-automation.md) | [Bahasa Indonesia](../id/08-ci-agent-automation.md) | [Tiếng Việt](../vi/08-ci-agent-automation.md) | [ไทย](../th/08-ci-agent-automation.md) | [Polski](../pl/08-ci-agent-automation.md)
...
- [CI And Agent Automation (English)](../08-ci-agent-automation.md)
