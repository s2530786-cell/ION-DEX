...
// CalculateLivePath computes the optimal live path (used by shadow monitoring).
func (re *RouterEngineV2) CalculateLivePath(ctx context.Context, amount *big.Int) (plugin.ExecutionPlan, error) {
	return re.calculateRealTime(ctx, amount)
}
