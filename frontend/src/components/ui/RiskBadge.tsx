  ...
  return (
    <GlassPanel variant={dangerous ? "magenta" : "cyan"} noAurora padding="sm">
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs font-mono font-bold text-white tracking-wider">{label}</span>
        <span className={`ml-auto text-[10px] font-mono font-bold tracking-widest ${dangerous ? "text-rose-200" : "text-emerald-200"}`}>
          {dangerous ? "RISK" : "SAFE"}
        </span>
      </div>
    </GlassPanel>
