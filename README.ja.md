...
ION の GitHub メインページへアクセスするための日本語ページです。

ION は一般的な DEX リポジトリではありません。交換インフラを起点に、決済、アイデンティティ、証明、レピュテーション、協調、自己進化へと拡張していく、長期志向のデジタルシステムです。
