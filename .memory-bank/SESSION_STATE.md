...
```
┌─────────────────────────────────────────────────────┐
│  旺财 (工头/操盘手)          │  Cursor (码农/执行器)   │
├──────────────────────────────┼───────────────────────┤
│  ✅ 定方向、排优先级          │  ✅ 写代码 (.tsx/.sol/.fc)│
│  ✅ 监督不跑偏、审查产出      │  ✅ 编译、测试、调试     │
│  ✅ 提供工具/环境/外部数据    │  ✅ 自主审计、自主修漏洞  │
│  ✅ 验证合约、审计报告        │  ✅ 高频 commit 小步快跑 │
│  ✅ 写 SESSION_STATE/审计报告 │  ✅ 读规范 → 实现代码    │
│  ❌ 不写业务代码              │  ❌ 不定方向/不写规范文档│
│  ❌ 不替 Cursor 写 .tsx/.sol │  ❌ 不创建 .mdc 设计文件 │
└──────────────────────────────┴───────────────────────┘
```

**一句话：旺财说做什么，Corsor 写代码做。旺财不说的事，Cursor 不做。**
