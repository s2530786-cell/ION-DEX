...
# ION — El sistema operativo para una supercivilización digital
...
- [Centro de documentación](./docs/es/index.md)
- [Resumen del whitepaper](./docs/whitepaper/es/WHITEPAPER.es.md)
- [Índice del whitepaper](./docs/es/whitepaper-index.md)
...
- [Centro de documentación](./docs/es/index.md)
- [Resumen del whitepaper](./docs/whitepaper/es/WHITEPAPER.es.md)
- [Whitepaper completo en inglés](./docs/WHITEPAPER.md)
