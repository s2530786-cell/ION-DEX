...
- **Stress + 100-pass（2026-05-20）**：`stress.mjs` health/config p95 250ms（修复 pass 27 误杀）。`verify-full` 绿灯；`verify-100.sh 100` 后台进行中。分支 `cursor/ui-design-workflow-44c9` commit `e6c504c`。
