...
export const VaultWidget: React.FC = () => {
  // 1. 状态管理：隐私开关与模拟链上数据 (L3 级实时对接预留)
  const [isPrivate, setIsPrivate] = useState(false);
  const [assets] = useState<AssetBalance[]>([
    { 
      symbol: 'ION', 
      name: 'ION Native', 
      amount: 1245082000000n, // 1,245.082 ION
      usdValue: 2664.47, 
      change24h: 12.4, 
      icon: '💎' 
    },
    { 
      symbol: 'USDT', 
      name: 'Tether USD', 
      amount: 420500000000n, // 420.5 USDT
      usdValue: 420.50, 
      change24h: 0.0, 
      icon: '💵' 
    }
    ...
    >
      ...
      <div className="flex justify-between items-center border-b border-white/5 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div className="font-mono">
            ...
            <p className="text-[9px] text-slate-500">0x71c...A42b</p>
          </div>
        </div>
        <button 
      ...
      <div className="space-y-1">
        ...
        <div className="flex items-baseline gap-2">
          ...
          {!isPrivate && (
            <span className="text-[10px] font-mono font-bold text-[#00FF66] flex items-center gap-0.5 mb-1">
