...
# ION — ระบบปฏิบัติการสำหรับอารยธรรมดิจิทัลระดับเหนือชั้น
...
- [ศูนย์เอกสาร](./docs/th/index.md)
- [ภาพรวม whitepaper](./docs/whitepaper/th/WHITEPAPER.th.md)
- [ดัชนี whitepaper](./docs/th/whitepaper-index.md)
...
- [ศูนย์เอกสาร](./docs/th/index.md)
- [ภาพรวม whitepaper](./docs/whitepaper/th/WHITEPAPER.th.md)
- [whitepaper ฉบับเต็มภาษาอังกฤษ](./docs/WHITEPAPER.md)
