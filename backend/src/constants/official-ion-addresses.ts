...
export const BSC_BURN_CONTRACT_PLACEHOLDER = "0x0000000000000000000000000000000000000000";

/** Optional VaultLock contract address from env — placeholder until mainnet deploy. */
export const BSC_VAULT_LOCK_PLACEHOLDER = "0x0000000000000000000000000000000000000000";
