...
### Core Architecture
- [Project Overview](./00-project-overview.md) — Full-stack Web3 trading and ecosystem portal.
- [Technical Architecture](./03-technical-architecture.md) — Multi-layer system: contracts, backend, frontend.
- [Tokenomics and Fees](./02-tokenomics-and-fees.md) — Fee structure, burn mechanism, staking rewards.
- [Development Roadmap](./04-development-roadmap.md) — Phase-by-phase execution plan.

### Security & Verification
- [Security Audit Matrix](./23-security-audit-and-stress-sandbox.md) — Attack vectors, test coverage, audit checklist.
- [Six Pillars Verification](./07-verification-six-pillars.md) — Trust foundation verification framework.
...
2. [Technical Architecture](./03-technical-architecture.md) — System layers and contracts.
3. [Developer Index](./developer-index.md) — API, SDK, contracts, quick start.
...
**Public-safe content:** All documents listed here are public-safe. Sensitive strategy, competitive tactics, and proprietary execution details remain in private layers.

**What you will NOT find here:**
- Detailed rollout timelines for unannounced modules.
- Competitive strategy against other DEXs.
- Internal arbitration and risk detail.
